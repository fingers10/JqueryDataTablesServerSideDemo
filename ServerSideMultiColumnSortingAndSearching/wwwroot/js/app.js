$(() => {
     if ($('#fingers10').length !== 0) {
         ...
         $('#fingers10 thead tr:last th').each(function () {
                ...
                $(this).addClass('p-0').html('<span class="sr-only">' + label + '</span><input type="search" class="form-control form-control-sm opacity-100 member-claims-search" disabled="disabled" aria-label="' + label + '" />');
            });
